...
\r
    let bounces: u32 = u32(scene.maxBounces); // we need a max or it'll go on forever\r
\r
...
fn hit_sphere(ray: Ray, sphere: Sphere, tMin: f32, tMax: f32, oldRenderState: RenderState) -> RenderState {\r
    // gotten from here: https://stackoverflow.com/questions/63922206/glsl-sphere-ray-intersection-geometric-solution\r
...
@group(0) @binding(2) var depth_buffer: texture_2d<f32>;\r
